      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative bg-card clean-border rounded-3xl overflow-hidden elevated-shadow">
            {/* Video Embed — youtube-nocookie variant + lazy load defer the */}
            {/* third-party iframe until the section is near the viewport, and */}
            {/* avoids dropping a tracking cookie until a visitor actually */}
            {/* presses play. */}
            <div className="relative">
              <div className="aspect-video">
                <iframe
                  src="https://www.youtube-nocookie.com/embed/fIbDWDh6aYw?rel=0&showinfo=0&modestbranding=1"
                  title="Hampton Commercial - The Lonely Journey"
                  loading="lazy"
                  referrerPolicy="origin"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  allowFullScreen
                  className="w-full h-full rounded-t-3xl border-0"
                />
              </div>
